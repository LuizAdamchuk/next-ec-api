...
const SOCIAL_LINKS = [
  {
    name: "GitHub",
    link: "https://github.com/luizAdamchuk",
  },
  {
    name: "Slack",
    link: "https://github.com/luizAdamchuk",
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>
                Ao lados você pode inserir diferentes jogos, categorias e
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>
                Em casa de dúvidas você pode nos encontrar nos links abaixo =)
              </P>
